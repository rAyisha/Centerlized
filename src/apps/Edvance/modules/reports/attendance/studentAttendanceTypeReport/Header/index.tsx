...
const Header = () => {
  ...
  const validate = (values: FormValues) => {
    ...
    if (!values.searchType) {
      errors.searchType = "Session is required";
    }
    ...
    if (!values.attendanceType) {
      errors.attendanceType = "Leave To Date is required";
    }
    return errors;
  };
      ...
      <div className="col-12 md:col-4 lg:col-4">
        ...
        <div className="col-12 md:col-4 lg:col-4">
          <DropDownField
            ...
            onChange={formik.handleChange}
            error={
              formik.touched.attendanceType && formik.errors.attendanceType
                ? (formik.errors.attendanceType as string)
                : ""
            }
          />
        </div>
