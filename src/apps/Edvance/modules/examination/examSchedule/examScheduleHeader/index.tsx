...
const ExamScheduleHeader: FunctionalComponent<Props> = ({ }) => {
  ...
  const handleCreate = () => {
    navigate("/edvance/examination/examschedule/examsubjects")
  }

  return (
    <div className="overall__profile__tab__header__class__timetable">
      <div className="totalcount_headerstudent mb-4">
        <div className="profile__tab__headertxt mb-4">Exam Schedule</div>
        <div className="mt-1">
          <Button
...
export default ExamScheduleHeader;
